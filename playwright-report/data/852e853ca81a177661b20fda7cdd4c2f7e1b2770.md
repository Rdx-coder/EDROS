...
- Name: workflow.spec.ts >> EDROS Banking & Debt Recovery Operating System E2E & Accessibility Tests >> 2. Operations tab navigation & View switching sanity checks
- Location: tests/e2e/workflow.spec.ts:46:3
...
Locator: locator('span:has-text("Operator:")')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('span:has-text("Operator:")')
...
- text: "SYSTEM_LOG:"
- paragraph: Multi-factor authentication required. An SMS and email OTP passcode has been dispatched.
- heading "Enter 6-Digit MFA Token" [level=3]
- paragraph: A verification check has been issued to +91-XXXXX-XX210.
- textbox "-"
- textbox "-"
- textbox "-"
- textbox "-"
- textbox "-"
- textbox "-"
- button "VERIFY ACCESS PASS"
- button "← Back to Login"
- text: "Resend OTP in 25s DEBUG NOTE:"
- paragraph: Type any numbers (e.g. 123456) or leave as is to log in directly. Multi-factor flow is fully validated.
